...
namespace PoorMansTSqlFormatter.SSMS21.VSIX
{
    ...
    internal sealed class FormatSqlCommand
    {
        ...
        private FormatSqlCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
            ...
            var cmdID = new CommandID(new Guid("a0a64345-bbf1-4c0e-9c74-61df4f88e2f0"), 0x0100);
            var menuItem = new OleMenuCommand(this.Execute2, cmdID);
            commandService?.AddCommand(menuItem);
        }
        ...
        private void Execute2(object sender, EventArgs e)
        {
            ...
            {
                var sql = selection.Text;
                var formatter = new TSqlStandardFormatter();
                selection.Text = formatter.FormatSQL(sql);
            }
        }
    }
}
